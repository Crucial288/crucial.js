...
var Crucial = /** @class */ (function () {
    ...
    Crucial.prototype.CreateComponents = function () {
        var _this = this;
        /// Create array of all potential nodes in app
        var newNodes = Array.from(this.app.querySelectorAll('*'))
            .filter(function (n) { return n.nodeName.startsWith('C-'); });
        ...
        for (var _i = 0, differentNodes_1 = differentNodes; _i < differentNodes_1.length; _i++) {
            ...
            if (component == null) {
                console.warn("Component with name: " + name_1 + " doesn't exist");
                return;
            }
            // try {
    ...
    Crucial.prototype.Update = function () {
        this.CreateComponents();
    };
    return Crucial;
}());
...
var Deeper = /** @class */ (function (_super) {
    __extends(Deeper, _super);
    function Deeper() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    Deeper.prototype.Template = function () {
...
var ButtonSpace = /** @class */ (function (_super) {
    __extends(ButtonSpace, _super);
